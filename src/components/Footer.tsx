      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-brand-green-200 text-sm leading-relaxed mb-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-sm text-brand-green-200">TripAdvisor</span>
              </div>
              <div className="flex items-center space-x-1">
                <span className="text-brand-gold-400 text-lg">★★★★★</span>
                <span className="text-sm text-brand-green-200">GetYourGuide</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-brand-green-700 flex flex-col md:flex-row items-center justify-between text-sm text-brand-green-400">
