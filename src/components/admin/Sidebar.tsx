...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-brand-navy-900 text-white flex flex-col min-h-screen">
      <div className="p-6 border-b border-brand-navy-700">
        <h1 className="font-serif text-lg font-bold leading-tight">Canterbury</h1>
        <p className="text-brand-navy-300 text-xs">Guided Tours Admin</p>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-colors duration-150 ${
                isActive
                  ? 'bg-brand-navy-700 text-white font-medium'
      ...
      <div className="p-4 border-t border-brand-navy-700">
        <Link
          href="/"
          className="flex items-center space-x-3 px-3 py-2 text-brand-navy-300 hover:text-white text-sm mb-1"
        >
          <span>🌐</span>
        ...
        <button
          ...
          className="flex items-center space-x-3 px-3 py-2 text-brand-navy-300 hover:text-white text-sm w-full text-left"
        >
          <span>🚪</span>
          <span>Sign Out</span>
        </button>
